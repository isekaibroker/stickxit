...
export const metadata: Metadata = { title: "Create a Campaign", description: "Choose a Stickxit placement, preview the creative, and authorize a wallet-linked campaign." };
